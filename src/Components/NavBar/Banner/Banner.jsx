        ...
        <section className="text-white py-5">
            <div className="container mx-auto flex flex-col md:flex-row items-center px-4">
                ...
                <div className="w-full md:w-1/2 text-center lg:text-left md:text-center lg:pr-60">
                    <h1 className="text-5xl font-bold mb-4">Ahad <span className="font-black" style={{ color: "#f9004d"}}>Ahamed</span></h1>
                    <p className="text-2xl mb-4 lg:text-left md:text-center font-bold">I am a web developer</p>
