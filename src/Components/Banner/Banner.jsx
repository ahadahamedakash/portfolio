      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center px-4">
        <div className="w-full md:w-1/2 mb-8 md:mb-0">
          <img
            ...
            alt="DEVELOPER"
            className="mx-auto rounded-lg w-full p-10"
          />
        </div>
        <div className="w-full md:w-1/2 text-center lg:text-left md:text-center lg:pr-60">
          <h1 className="text-4xl font-bold mb-4">
            Hi There, I am Ahad{" "}
            <span className="font-black text-4xl" style={{ color: "#f9004d" }}>
              Ahamed
            </span>
          </h1>
          <p className="text-2xl mb-4 lg:text-left md:text-center font-bold">
            A Web Developer and A Designer
          </p>
          <p
            style={{ color: "#f9004d" }}
            className="text-lg lg:text-left md:text-center"
          >
            A Front-End Web Developer who is a tech industry professional and
